...
## Health & Fitness
- [BMI Calculator](https://go-calc.com/tools/bmi-calculator/) - Body Mass Index
- [Calorie Calculator](https://go-calc.com/tools/calorie-calculator/) - Daily calorie needs
- [Body Fat Calculator](https://go-calc.com/tools/body-fat-calculator/) - Estimate body fat percentage

## Unit Conversion
- [Kg to Lbs](https://conv-kit.com/tools/kg-to-lbs/) - Kilogram to pound conversion
- [Celsius to Fahrenheit](https://conv-kit.com/tools/celsius-to-fahrenheit/) - Temperature conversion
- [Miles to Km](https://conv-kit.com/tools/miles-to-km/) - Distance conversion

## Math Calculators
- [Percentage Calculator](https://go-calc.com/tools/percentage-calculator/) - All percentage calculations
- [Fraction Calculator](https://go-calc.com/tools/fraction-calculator/) - Add, subtract, multiply fractions
- [GPA Calculator](https://go-calc.com/tools/gpa-calculator/) - Calculate grade point average

## Contributing
PRs welcome! Add your favorite free calculator tools.
